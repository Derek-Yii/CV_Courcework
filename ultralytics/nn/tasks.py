...
from ultralytics.nn.modules import (
    ...
    iRMB,
    DSConv,
    DSConv_c2f,DilateBlock, C2f_MultiDilatelocalAttention,C2f_DWR,
    EVCBlock,
    SDI,
)
...
def parse_model(d, ch, verbose=True):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d["backbone"] + d["head"]):  # from, number, module, args
        ...
        if m in (
            ...
            C3x,
            RepC3,
            iRMB,DilateBlock,C2f_MultiDilatelocalAttention,C2f_DWR,
        ):
            c1, c2 = ch[f], args[0]
            ...
            args = [c1, c2, *args[1:]]
            if m in (BottleneckCSP, C1, C2, C2f, C2fAttn, C3, C3TR, C3Ghost, C3x, RepC3, DilateBlock, C2f_MultiDilatelocalAttention,C2f_DWR):
